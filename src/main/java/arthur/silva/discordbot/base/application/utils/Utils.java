...
public class Utils {
     ...
     */
    public static StringBuilder getListDisplayNumbered(@NotNull String separator, @NotNull Object[] elems) {
        StringBuilder sb = new StringBuilder();
        if (elems.length != 0)
    ...
    public static String batchToggleRoles(@NotNull Guild guild, @NotNull Member member, @NotNull List<Long> rolesIds) {
        ...
        try {
            ...
            resultMessage = "Failed to add roles due to unknown error.";
            e.printStackTrace();
        }
     ...
     */
    public static Calendar getNextDayOfMonth(@NotNull List<Integer> targetDays, boolean includeToday, int hour, int minute) {
